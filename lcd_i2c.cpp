...
// ---------------------------------------------------------------------------
// Copyright 2017 Darryl Newberry
#include <stdio.h>
#include <string.h>
#include <inttypes.h>
...
// LCD data lines pin mapping of the extender module
#define D4 0
#define D5 1
#define D6 2
#define D7 3
...
lcd_i2c::lcd_i2c(uint8_t lcd_Addr, uint8_t En, uint8_t Rw,
                                     uint8_t Rs, uint8_t d4, uint8_t d5,
                                     uint8_t d6, uint8_t d7, uint8_t backlightPin,
...
void lcd_i2c::config (uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs,
